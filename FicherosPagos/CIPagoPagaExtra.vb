Public Class CIPagoPagaExtra
    ...
    Private Sub CIPagoPagaExtra_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        loadToolbarActions()
        CmbAño.Value = Now.Year
        RellenarComboAños(CmbAño)
    End Sub

    Private Sub julio_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RdbJulio.CheckedChanged
        CmbMes.Text = "6"
    End Sub

    Private Sub diciembre_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RdbDiciembre.CheckedChanged
        CmbMes.Text = "12"
    End Sub

    Private Sub CIPagoPagaExtra_QueryExecuting(ByVal sender As Object, ByRef e As Solmicro.Expertis.Engine.UI.QueryExecutingEventArgs) Handles Me.QueryExecuting
        With e.Filter
    ...
    Private Sub CIPagoLiquidaciones_QueryExecuted(ByVal sender As Object, ByRef e As Solmicro.Expertis.Engine.UI.QueryExecutedEventArgs) Handles Me.QueryExecuted
        NtbTotal.Value = Grid.GetTotal(Grid.Columns("PagaExtra"), AggregateFunction.Sum)
    End Sub
    ...
    Private Sub Grid_RecordChecked(ByVal sender As Object, ByVal e As Solmicro.Expertis.Engine.UI.CheckedEventArgs) Handles MyBase.RecordChecked
        If e.CheckState = CheckStates.Checked Then
            dblTotalMarcado = dblTotalMarcado + e.Row.Cells("PagaExtra").Value()
        Else
            dblTotalMarcado = dblTotalMarcado - e.Row.Cells("PagaExtra").Value()
        End If
    ...
    Private Sub CIPagoPagaExtra_SetReportDataSource(ByVal sender As Object, ByVal e As Solmicro.Expertis.Engine.UI.ReportDataSourceEventArgs) Handles Me.SetReportDataSource
        Select Case e.Alias
            Case "INFPagaExtra"
    ...
    Function AccionFicheroTransferencia(ByVal strBanco As String)
        ...
        If Len(strBanco) Then
            ...
            If Len(strRuta & vbNullString) Then
                ...
                datFich.strTipoFichero = "PagaExtra"
                ...
                If Not lstRegsFich Is Nothing AndAlso lstRegsFich.Length > 0 AndAlso General.GuardarFicheroXML(lstRegsFich, strRuta, -1, datFich.FechaCargo, True) Then
                    ...
                    Dim informe As New Report("INFPagaExtra")
